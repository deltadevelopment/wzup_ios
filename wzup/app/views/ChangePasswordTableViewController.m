...
- (IBAction)doneAction:(id)sender {
    ...
    //Bytt passord
        [settingsController changePassword:self.passwordTextField.text withObject:self withSuccess:@selector(passwordWasChanged:) withError:@selector(passwordWasNotChanged:)];
